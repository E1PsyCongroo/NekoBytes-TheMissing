...
## Part3 小任务
接下来我们将会有一些小小的任务,这里会有三份程序源码以及三个十六进制文件,你需要做的就是通过烧录之后的现象,给他们进行配对,很简单吧.
假如
...
所以我们需要虚拟程序来模拟一块51,vivado自然是一个很好的选择,这里附上下载链接[vivado](https://www.xilinx.com/support/download.html)